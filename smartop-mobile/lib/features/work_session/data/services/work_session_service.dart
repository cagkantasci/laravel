...
class WorkSessionService {
  ...
  Future<WorkSession?> getActiveSession() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${AppConstants.apiBaseUrl}/work-sessions/active'),
        headers: headers,
      );
  ...
  Future<List<WorkSession>> getMySessions() async {
    try {
      final headers = await _getHeaders();
      final response = await http.get(
        Uri.parse('${AppConstants.apiBaseUrl}/work-sessions/my-sessions'),
        headers: headers,
      );
      ...
      debugPrint('Error getting my sessions: $e');
      return [];
    }
  }
  ...
  Future<Map<String, dynamic>> startSession({
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('${AppConstants.apiBaseUrl}/work-sessions/start'),
        headers: headers,
  ...
  Future<Map<String, dynamic>> endSession({
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('${AppConstants.apiBaseUrl}/work-sessions/$sessionId/end'),
        headers: headers,
        body: json.encode(body),
      );
  ...
  Future<Map<String, dynamic>> getStatistics({
    ...
    try {
      final headers = await _getHeaders();
      var url = '${AppConstants.apiBaseUrl}/work-sessions/statistics';
